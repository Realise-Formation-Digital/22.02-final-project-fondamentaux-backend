...
class ArtisteMusiqueModel extends Database
{
  ...
  public function getSingleArtisteMusique($artiste_id)
  {
    ...
    return $this->getSingle(
      ...
      // "ArtisteMusiqueModel"
      "SELECT a.groupe, m.nom FROM artiste a INNER JOIN artiste_musique am ON am.artiste_id = a.id 
      INNER JOIN musique m ON m.id = am.musique_id WHERE a.id = $artiste_id"
      //"ArtisteMusiqueModel"
    );
  }
