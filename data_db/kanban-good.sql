...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2405195709ltr&server=1">
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/printview.css?v=5.1.3" media="print" id="printcss">
    <title>portainer.realise.ch:58080 / portainer.realise.ch:4306 | phpMyAdmin 5.1.3</title>
...
<body>
    <div id="pma_navigation" data-config-navigation-width="376">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=kanban&table=users">`kanban`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=kanban&table=tasks">`kanban`.`tasks`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=kanban&table=columns">`kanban`.`columns`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6541385655325426606878466a71565c">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="376"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
...
<nav id="server-breadcrumb" aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item">
      ...
      <a href="index.php?route=/" data-raw-text="portainer.realise.ch:4306">
        Server:        portainer.realise.ch:4306
      </a>
    </li>
